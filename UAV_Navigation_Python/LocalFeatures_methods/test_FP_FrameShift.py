...
def imregFeaturePoins(img1, img2, detector=cv2.SURF(), matcher=cv2.BFMatcher(cv2.NORM_L2), isDebug=True, minNumGoodPairs=10, isUseCorrQuality=True):
    ...
    while True:
        ...
        if ret:
            ...
            if isFirstFrame:
                ...
                isFirstFrame=False
                continue
            H,Q,Pano=imregFeaturePoins(frmPrev, frm, isDebug=True, detector=detector)
