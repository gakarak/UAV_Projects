#include "gradient_density.h"

#include <opencv2/imgproc.hpp>

double utils::cv::gradientDensity(::cv::Mat image)
{
...
QPointF utils::cv::toQPointF(::cv::Point2f pt)
{
  return QPointF(pt.x, pt.y);
}

::cv::Point2f utils::cv::toPoint2f(QPointF pt)
{
