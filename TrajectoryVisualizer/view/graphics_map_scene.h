...
namespace viewpkg
{
    ...
    public:
        ...
        GraphicsOrientationItem&    getGhostOrientation()   { return ghostOrientation; }
        ...
        const GraphicsOrientationItem&    getGhostOrientation() const   { return ghostOrientation; }
    ...
    private:
        ...
        GraphicsOrientationItem ghostOrientation;
